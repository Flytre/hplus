...
public class HopperPlusBlockItem extends BlockItem {
    public HopperPlusBlockItem(Block block, Settings settings) {
    ...
    public static ItemStack getItemStack(DefaultedList<ItemStack> inv) {
        ...
        ItemStack result = new ItemStack(RegistryHandler.HOPPER_PLUS);
        result.setTag(tag3);
        return result;
    }
